...
<br>
<p>마이그레이션 사용 사례에 대해 다음 시나리오를 가정한다.  
<p><img src="https://github.com/hayleyshim/hayleyshim.github.io/blob/master/assets/images/projects/scenario.PNG?raw=true">  
<p>Master Node에서 Worker Node로 애플리케이션을 마이그레이션한다.<a href="https://velero.io/docs/v1.7/migration-case/">(참고:velero migration case)</a>
<br>
<br>  
<p><b>1. 사전 작업</b>
