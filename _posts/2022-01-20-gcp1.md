...
<br>
<br>
<p><b>Bastion host 접근 방법</b>  
<p><b>Create the VM instances</b>  
<p>- Create a VPC network and firewall rules
<p>- Create the VM instance with no public IP address 
<p>- Create the bastion host
<p>- SSH to vm-bastion and verify access to vm-internal 
<p><b>Enable Private Google Access</b>
<p>- Create a Cloud Storage bucket
<p>- Copy an image file into your bucket
<p>- Access the image from your VM instances
<p>- Enable Private Google Access
<p><b>Configure a Cloud NAT gateway</b>
<p>- Try to update the VM instances
<p>- Configure a Cloud NAT gateway
<p>- Verify the Cloud NAT gateway
<p><b>Configure and view logs with Cloud NAT Logging</b>
<p>- Enabling logging
<p>- NAT logging in Stackdriver
<p>- Generating logs
<p>- Viewing Logs
<br>
<br>   
