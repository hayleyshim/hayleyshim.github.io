...
<html>
    <head>
        ...
        <br><br>
        <p>	
        <p><b>1. 콘텐츠 주소 지정(Content Addressing)</b> : 사용자가 NFT.Storage에 데이터를 업로드하면 <a href="https://docs.ipfs.io/concepts/content-addressing/#identifier-formats">CID</a> 라고 하는 콘텐츠의 IPFS 해시를 받는다 . CID는 데이터의 고유한 지문이며 저장 방법과 위치에 관계없이 콘텐츠를 참조하는 데 사용할 수 있는 범용 주소이다. CID는 콘텐츠 자체에서 생성되기 때문에 CID를 사용하여 NFT 데이터를 참조하면 취약한 링크 및 "러그 풀(rug pull)" 과 같은 문제를 방지할 수 있다 .
