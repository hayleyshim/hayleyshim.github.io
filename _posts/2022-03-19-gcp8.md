...
<br>
<br>  
<p>- 참고로 위 코드는 VPC, Network, Instance(VM, DB)에 대한 구성이 되어 있고 IAP, LB, DB 기능에 대해 추후 Terraform 옵션을 공부한 후 업데이트 필요하다.(Issue는 github code에 남겨주시면 확인 후 답하겠습니다. 언제든 환영합니다^^)  
<br>
<br>  
